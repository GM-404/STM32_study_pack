...
#define PWM_PWM_MODULE_AFIO (1) // timer2引脚映射到AFIO的引脚定义 0为默认引脚PA0，1为重映射引脚PA15
#define MOTOR_MODULE        (0) // 电机模块开关

#define USART1_MODULE       (1) // USART模块开关
#define ADC_MODULE          (0) // ADC模块开关
// 引脚定义
#define LED_PIN GPIO_Pin_4                                          // 在这里定义LED的引脚  GPIOA
#define KEY_PIN GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_10 | GPIO_Pin_11 // 按键引脚定义 GPIOB 0,1,10,11
...
#define PWM_MODULE_PIN GPIO_Pin_15 // 定时器2引脚映射到AFIO的引脚定义 与上面对应，这里用来作为赛题的PA7平替
#else
